...
// @ts-ignore
import { PatchSubscriptionOrganizationModel } from '../model/patchSubscription';
// @ts-ignore
...
export class SubscriptionsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteSubscription(subscriptionGuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any>;
    public deleteSubscription(subscriptionGuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<any>>;
    public deleteSubscription(subscriptionGuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<any>>;
    public deleteSubscription(subscriptionGuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/api/subscriptions/${encodeURIComponent(String(subscriptionGuid))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listSubscriptions(page?: string, perPage?: string, guid?: string, environment?: string, state?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<SubscriptionListOrganizationModel>;
    public listSubscriptions(page?: string, perPage?: string, guid?: string, environment?: string, state?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<SubscriptionListOrganizationModel>>;
    public listSubscriptions(page?: string, perPage?: string, guid?: string, environment?: string, state?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<SubscriptionListOrganizationModel>>;
    public listSubscriptions(page?: string, perPage?: string, guid?: string, environment?: string, state?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
     ...
     * @param subscriptionGuid Identifier for the subscription.
     * @param patchSubscriptionOrganizationModel 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public updateSubscription(subscriptionGuid: string, patchSubscriptionOrganizationModel: PatchSubscriptionOrganizationModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<SubscriptionOrganizationModel>;
    public updateSubscription(subscriptionGuid: string, patchSubscriptionOrganizationModel: PatchSubscriptionOrganizationModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<SubscriptionOrganizationModel>>;
    public updateSubscription(subscriptionGuid: string, patchSubscriptionOrganizationModel: PatchSubscriptionOrganizationModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<SubscriptionOrganizationModel>>;
    public updateSubscription(subscriptionGuid: string, patchSubscriptionOrganizationModel: PatchSubscriptionOrganizationModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (subscriptionGuid === null || subscriptionGuid === undefined) {
            throw new Error('Required parameter subscriptionGuid was null or undefined when calling updateSubscription.');
        }
        if (patchSubscriptionOrganizationModel === null || patchSubscriptionOrganizationModel === undefined) {
            throw new Error('Required parameter patchSubscriptionOrganizationModel was null or undefined when calling updateSubscription.');
        }
        ...
        return this.httpClient.patch<SubscriptionOrganizationModel>(`${this.configuration.basePath}/api/subscriptions/${encodeURIComponent(String(subscriptionGuid))}`,
