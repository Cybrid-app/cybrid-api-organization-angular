...
export class SubscriptionsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getSubscription(subscriptionGuid: string, includeSigningKey?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<SubscriptionOrganizationModel>;
    public getSubscription(subscriptionGuid: string, includeSigningKey?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<SubscriptionOrganizationModel>>;
    public getSubscription(subscriptionGuid: string, includeSigningKey?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<SubscriptionOrganizationModel>>;
    public getSubscription(subscriptionGuid: string, includeSigningKey?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (subscriptionGuid === null || subscriptionGuid === undefined) {
            throw new Error('Required parameter subscriptionGuid was null or undefined when calling getSubscription.');
        }

        let localVarQueryParameters = new HttpParams({encoder: this.encoder});
        if (includeSigningKey !== undefined && includeSigningKey !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>includeSigningKey, 'include_signing_key');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listSubscriptions(page?: string, perPage?: string, guid?: string, includeSigningKey?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<SubscriptionListOrganizationModel>;
    public listSubscriptions(page?: string, perPage?: string, guid?: string, includeSigningKey?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<SubscriptionListOrganizationModel>>;
    public listSubscriptions(page?: string, perPage?: string, guid?: string, includeSigningKey?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<SubscriptionListOrganizationModel>>;
    public listSubscriptions(page?: string, perPage?: string, guid?: string, includeSigningKey?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
